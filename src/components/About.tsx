      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in mb-12">
          ...
          <div>
            ...
            <p className="text-foreground/90 leading-relaxed">
              Curiosity drives me. I love learning for its own sake — from psychology and language to physics and philosophy. Philosophy, in particular, has shaped how I think — it teaches me to question assumptions and look deeper into multiple perspectives. I also enjoy sketching in my free time.
            </p>
          </div>
