        ...
        <div className="space-y-12 animate-fade-in">
          <div>
            ...
            <p className="text-foreground/90 leading-relaxed">
              Empathy and evidence guide my design. My process begins by understanding people — their motivations, needs, and contexts — and evolves through ideation, iteration, and testing. My background in Industrial Engineering, with a focus on Human Factors, helps me combine psychology, design principles, and data-driven insights to create human-centered experiences.
            </p>
          </div>
