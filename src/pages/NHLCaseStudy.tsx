          ...
          <article className="space-y-14 animate-fade-in">
            <Section title="Problem">
              <p className="text-foreground/80 leading-relaxed">
                NHL draft outcomes depend on a mix of player performance metrics, team need, and historical draft
                patterns that aren't obvious from raw stats alone. The goal was to see whether structured historical
                data could meaningfully predict both team standings and individual draft outcomes.
              </p>
            </Section>
